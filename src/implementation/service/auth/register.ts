import { AuthDeps } from "src/implementation/service/auth/deps";
import { User } from "src/application/repository/user/entity/user.entity";
import {
  validateEmail,
  validatePassword,
} from "src/implementation/service/auth/logic/auth.logic";
import { generateName, generateTag } from "src/implementation/service/user/logic/user.logic";

import { RegisterReqDto, RegisterResDto } from "src/application/service/auth/dto/auth.dto";
